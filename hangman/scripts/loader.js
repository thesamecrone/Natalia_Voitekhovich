...
const loadData = () => {
	...
	queue.loadFile({ id: "correct", src: "/hangman/audios/correct.mp3" });
	queue.loadFile({ id: "wrong", src: "/hangman/audios/wrong.mp3" });
	queue.loadFile({ id: "win", src: "/hangman/audios/win.mp3" });
	queue.loadFile({ id: "lose", src: "/hangman/audios/lose.mp3" });
	queue.loadFile({ id: "rotate", src: "/hangman/audios/rotate.mp3" });
	queue.loadFile({ id: "pullup", src: "/hangman/audios/pullup.mp3" });
	queue.loadFile({ id: "hang", src: "/hangman/audios/hang.mp3" });
